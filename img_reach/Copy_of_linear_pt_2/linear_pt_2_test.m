...
%This system from Example 1 of 
%"On the Computation of the Peak of the Impulse Response of LTI Systems" 
%by Chesi and Shen
...
%     mom_handle = @(d) LebesgueBoxMom(d, box_supp', 1);
    ...
    mom_handle = @(d) LebesgueSphereMom(monpowers(2, d), box_lim);

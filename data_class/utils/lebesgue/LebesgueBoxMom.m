...
%originally titled getLebesgueMomentsNew.m

% Computes the monomial moments up to degree d of the n-dimensional lebesgue measure over a box
...
function moments = LebesgueBoxMom( d, box, YalmipBasis )
